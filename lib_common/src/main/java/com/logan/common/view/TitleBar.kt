...
import com.logan.common.databinding.LayoutTitleBarBinding
...
class TitleBar @JvmOverloads constructor(
    ...
    fun setBackLayerClick(block: ((View) -> Unit)) {
        mBinding.llBackLayer.onClick(200,block)
    }

    fun setRightLayerClick(block: ((View) -> Unit)) {
        mBinding.llRightLayer.onClick(200,block)
    }
