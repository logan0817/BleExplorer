package com.logan.presentation.navigator
...
class LoganFragmentNavigator(context: Context, manager: FragmentManager, containerId: Int) :
    ...
    private val TAG = "LoganFragmentNavigator"
